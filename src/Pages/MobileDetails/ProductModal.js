  ...
  const handSubmit = (event) => {
    if (user) {
      ...
      const booking = {
        ...
        email: user?.email,
        price: totalPrice,
        adress1: users?.adress1,
        adress2: users?.adress2,
        quantity: cart,
        ...
        <div className="modal-box relative">
          ...
          <form onSubmit={handSubmit} className="p-0 lg:p-8">
            ...
            <div className="flex justify-center items-center">
              <input
                className="py-3 px-6 rounded-md border border-gray-300 text-white bg-black shadow-2xl hover:bg-gray-700 cursor-pointer"
                type="submit"
                value="submit"
              />
            </div>
