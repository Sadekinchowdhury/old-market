    ...
    <div className="flex justify-center items-center py-3">
      <div className="flex h-auto  flex-col  bg-gray-900 text-white">
        ...
        <div className="text-center mb-8 ">
          ...
          <p className="text-sm  text-white">{users?.email}</p>
        </div>
        ...
        <nav className="flex-grow">
          <ul className="flex flex-col">
            ...
            <Link
              className="p-4 mt-4 hover:rounded-lg  hover:border-blue-700 hover:border-[0.5px] transition duration-300 items-center flex hover:scale-110 hover:bg-gray-800"
            ...
            {isAdmin && (
              <>
                <Link
                  className="p-4 mt-4 hover:rounded-lg  hover:border-blue-700 hover:border-[0.5px] transition duration-300 hover:scale-110 items-center hover:bg-gray-800 flex gap-2"
                  to="/dashboard/users"
                >
                  <FaUserAlt size={20} />
                  All user
                ...
                <Link
                  className="p-4 mt-4 hover:rounded-lg  hover:border-blue-700 hover:border-[0.5px] transition duration-300 items-center hover:scale-110 hover:bg-gray-800 flex gap-2"
                  to="/dashboard/buyer"
                >
                  <FaHouseUser size={20} />
                  All buyers
            ...
            {isSeller && (
              <>
                <Link
                  className="p-4 mt-4 hover:rounded-lg  hover:border-blue-700 hover:border-[0.5px] transition duration-300 hover:scale-110 items-center hover:bg-gray-800   "
